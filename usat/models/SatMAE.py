...
from usat.utils.satmae_helpers import get_2d_sincos_pos_embed, get_1d_sincos_pos_embed_from_grid
from usat.utils.builder import MODEL
from usat.models.SatViT import SatViTEncoder

class SatMAE(SatViTEncoder):
    """ Masked Autoencoder with VisionTransformer backbone
    """

    def __init__(self, img_size=224, patch_size=8, in_chans=10, spatial_mask=False,
                 channel_groups=None,
        ...
        super().__init__(channel_embed=channel_embed, img_size=img_size, 
                         patch_size=patch_size, in_c=in_chans, embed_dim=embed_dim,
                         channel_groups=channel_groups, num_heads=num_heads, depth=depth,
